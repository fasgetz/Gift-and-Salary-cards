...
namespace Gift_and_Salary_cards.Migrations.GiftCards
{
    ...
    [Migration("20210830120624_renameEntityPayment")]
    partial class renameEntityPayment
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gift_and_Salary_cards.Models.DataBase.Payment", b =>
                {
                    b.HasOne("Gift_and_Salary_cards.Models.DataBase.AccountBankStore", "accountBankStore")
                        .WithOne("Payment")
                        .HasForeignKey("Gift_and_Salary_cards.Models.DataBase.Payment", "Id")
                        .HasConstraintName("FK_Payment_AccountBankStore")
                        .IsRequired();

                    b.HasOne("Gift_and_Salary_cards.Models.DataBase.BankCardPayout", "bankCardPayout")
                        .WithOne("Payment")
                        .HasForeignKey("Gift_and_Salary_cards.Models.DataBase.Payment", "Id")
